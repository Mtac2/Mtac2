...
MProof.
  Tor (Tthen (Trefine (or_introl _)) (Trefine I)) (fun _ =>Trefine _).
(* Problem: the subgoals generated by or_introl are still there.
   The api is too imperative. *)
Fail Qed.

Example basic7 : False \/ True.
MProof.
  Trefine (or_intror _). (Trefine I))
