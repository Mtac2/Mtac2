...
Polymorphic Definition find@{i j k k1 k2 k3 a1 a2 a3 a4 a5 a6 a7 a8} {A:Type@{i}} :=
...
Polymorphic Definition assumption@{i j k k1 k2 k3 a1 a2 a3 a4 a5 a6 a7 a8} {A:Type@{i}} : M.t@{a3 j k} A :=
  l <- hyps;
  @find@{i j k k1 k2 k3 a1 a2 a3 a4 a5 a6 a7 a8} A l.
