...
Inductive goal@{U131 U132} : goal_state -> Type :=
  | Goal : forall (s : Sort) {A : stype_of@{U131 U132} s}, selem_of@{U131 U132} A -> goal gs_base
  | GoalOut : forall (s : Sort) {A : stype_of@{U131 U132} s}, selem_of@{U131 U132} A -> goal gs_any
