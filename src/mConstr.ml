...
let mconstr_to_string (type a) (mh : a mconstr_head) =
  match mh with
  | Mret -> "ret"
  | Mbind -> "bind"
  | Mmtry' -> "mtry'"
  ...
  | Mabs_fun -> "abs_fun"
  | Mabs_let -> "abs_let"
  | Mabs_prod_prop -> "abs_prod_prop"
  | Mabs_prod_type -> "abs_prod_type"
  | Mabs_fix -> "abs_fix"
  | Mget_binder_name -> "get_binder_name"
  | Mremove -> "remove"
  | Mgen_evar -> "gen_evar"
  | Mis_evar -> "is_evar"
  | Mhash -> "hash"
  | Msolve_typeclasses -> "solve_typeclasses"
  | Mprint -> "print"
  | Mpretty_print -> "pretty_print"
  | Mhyps -> "hyps"
  | Mdestcase -> "destcase"
  | Mconstrs -> "constrs"
  | Mmakecase -> "makecase"
  | Munify -> "unify"
  | Munify_univ -> "unify_univ"
  | Mget_reference -> "get_reference"
  | Mget_var -> "get_var"
  | Mcall_ltac -> "call_ltac"
  | Mlist_ltac -> "list_ltac"
  | Mread_line -> "read_line"
  | Mdecompose -> "decompose"
  | Msolve_typeclass -> "solve_typeclass"
  | Mdeclare -> "declare"
  | Mdeclare_implicits -> "declare_implicits"
  | Mos_cmd -> "os_cmd"
  | Mget_debug_exceptions -> "get_debug_exceptions"
  | Mset_debug_exceptions -> "set_debug_exceptions"
  | Mget_trace -> "get_trace"
  | Mset_trace -> "set_trace"
  | Mdecompose_app' -> "is_head"
  | Mdecompose_forallT -> "decompose_forallT"
  | Mdecompose_forallP -> "decompose_forallP"
  | Mdecompose_app'' -> "decompose_app''"
  | Mnew_timer -> "new_timer"
  | Mstart_timer -> "start_timer"
  | Mstop_timer -> "stop_timer"
  | Mreset_timer -> "reset_timer"
  | Mprint_timer -> "print_timer"
  | Mkind_of_term -> "kind_of_term"
