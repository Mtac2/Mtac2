...
val isret : Evd.evar_map -> EConstr.t -> bool
val isbind : Evd.evar_map -> EConstr.t -> bool
val istry' : Evd.evar_map -> EConstr.t -> bool
val israise : Evd.evar_map -> EConstr.t -> bool
val isfix1 : Evd.evar_map -> EConstr.t -> bool
val isfix2 : Evd.evar_map -> EConstr.t -> bool
val isfix3 : Evd.evar_map -> EConstr.t -> bool
val isfix4 : Evd.evar_map -> EConstr.t -> bool
val isfix5 : Evd.evar_map -> EConstr.t -> bool
val isis_var : Evd.evar_map -> EConstr.t -> bool
val isnu : Evd.evar_map -> EConstr.t -> bool
val isabs_fun : Evd.evar_map -> EConstr.t -> bool
val isabs_let : Evd.evar_map -> EConstr.t -> bool
val isabs_prod_prop : Evd.evar_map -> EConstr.t -> bool
val isabs_prod_type : Evd.evar_map -> EConstr.t -> bool
val isabs_fix : Evd.evar_map -> EConstr.t -> bool
val isget_binder_name : Evd.evar_map -> EConstr.t -> bool
val isremove : Evd.evar_map -> EConstr.t -> bool
val isgen_evar : Evd.evar_map -> EConstr.t -> bool
val isis_evar : Evd.evar_map -> EConstr.t -> bool
val ishash : Evd.evar_map -> EConstr.t -> bool
val issolve_typeclasses : Evd.evar_map -> EConstr.t -> bool
val isprint : Evd.evar_map -> EConstr.t -> bool
val ispretty_print : Evd.evar_map -> EConstr.t -> bool
val ishyps : Evd.evar_map -> EConstr.t -> bool
val isdestcase : Evd.evar_map -> EConstr.t -> bool
val isconstrs : Evd.evar_map -> EConstr.t -> bool
val ismakecase : Evd.evar_map -> EConstr.t -> bool
val isunify : Evd.evar_map -> EConstr.t -> bool
val isunify_univ : Evd.evar_map -> EConstr.t -> bool
val isget_reference : Evd.evar_map -> EConstr.t -> bool
val isget_var : Evd.evar_map -> EConstr.t -> bool
...
val isdeclare_implicits : Evd.evar_map -> EConstr.t -> bool
val isos_cmd : Evd.evar_map -> EConstr.t -> bool
val isget_debug_ex : Evd.evar_map -> EConstr.t -> bool
val isset_debug_ex : Evd.evar_map -> EConstr.t -> bool
val isget_trace : Evd.evar_map -> EConstr.t -> bool
val isset_trace : Evd.evar_map -> EConstr.t -> bool
val isdecompose_app : Evd.evar_map -> EConstr.t -> bool
val isdecompose_forallT : Evd.evar_map -> EConstr.t -> bool
val isdecompose_forallP : Evd.evar_map -> EConstr.t -> bool
val isdecompose_app'' : Evd.evar_map -> EConstr.t -> bool
val isnew_timer : Evd.evar_map -> EConstr.t -> bool
val isstart_timer : Evd.evar_map -> EConstr.t -> bool
val isstop_timer : Evd.evar_map -> EConstr.t -> bool
val isreset_timer : Evd.evar_map -> EConstr.t -> bool
val isprint_timer : Evd.evar_map -> EConstr.t -> bool
val iskind_of_term : Evd.evar_map -> EConstr.t -> bool
